...
local function getSafeZoneCFrame()
	...
	if line then
		return line.CFrame * CFrame.new(0, 3, 16)
	end
	return nil
end
...
local function stealBestEgg()
	while stealEggEnabled do
		...
		if prompt and targetPart then
			tweenTo(targetPart.CFrame * CFrame.new(0, 3, 0), 120)
